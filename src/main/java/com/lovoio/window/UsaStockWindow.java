...
import com.lovoio.dto.entity.UsaDataStock;
 ...
 * @description : 港股
 **/
public class UsaStockWindow extends BaseDataWindow {
    ...
    public UsaStockWindow(List<BaseData> baseDataList) {
        super(baseDataList);
        ...
        UsaDataStock usaDataStock = new UsaDataStock();
        hashMap.put(usaDataStock.getUri(), usaDataStock);
